...
export const SERVICES_DATA = [
  { n:'Brand & Influencer Reels', num:'01', img:'/UORFI THUMBNAIL.jpg', d:'Platform-native reels and influencer content engineered for scroll-stopping engagement.' },
  { n:'Product / Commercials',    num:'02', img:'/PINK PRODUCT THUMBNAIL.jpeg', d:'High-production product films and commercials built for brand impact.' },
  { n:'Podcast',                  num:'03', img:'/SAMAY RAINA THUMBNAIL.jpeg', d:'Studio-grade podcast production with cinematic visual storytelling.' },
  { n:'TVC / DVC',                num:'04', img:'/SHANTANU THUMBNAIL.png', d:'Television and digital video commercials engineered for mass reach.' },
  ...
  { n:'Ecommerce',                num:'06', img:'/Ecommerce.jpg', d:'Conversion-driven product imagery and lifestyle content for online retail.' },
