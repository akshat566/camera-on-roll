...
export const CLIENTS: Client[] = [
  ...
  { name: 'Bombay Times Fashion Week', logo: null,                    domain: '' },               // event: no Clearbit entry
  { name: 'Emaar India',               logo: null,                    domain: '' },               // regional entity: no Clearbit entry
