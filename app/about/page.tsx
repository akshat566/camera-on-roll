      ...
      <section id="founders" style={{ borderTop:'1px solid var(--white-08)', background:'var(--black)', paddingTop:'calc(var(--nav-h) + 40px)', paddingBottom:'clamp(40px,5vw,64px)' }}>
        <div className="cx">
          <Reveal>
            ...
            <h2 style={{ fontFamily:'var(--font-display)', fontSize:'clamp(28px,4vw,56px)', textTransform:'uppercase', lineHeight:0.92, letterSpacing:'-0.02em', color:'var(--white)', marginBottom:'clamp(28px,4vw,48px)' }}>
              The Founders
            </h2>
          </Reveal>
          ...
          <div style={{ display:'grid', gridTemplateColumns:'repeat(auto-fit,minmax(min(100%,260px),1fr))', gap:'clamp(28px,4vw,56px)' }}>
            ...
            <Reveal delay={0.1}>
              <div style={{ position:'relative' }}>
                <div style={{ aspectRatio:'4/5', maxWidth:'280px', overflow:'hidden', background:'var(--surface)', marginBottom:'16px' }}>
                ...
                <h3 style={{ fontFamily:'var(--font-display)', fontSize:'clamp(18px,2vw,28px)', textTransform:'uppercase', color:'var(--white)', marginBottom:'4px', lineHeight:1 }}>Akshat Bhardwaj</h3>
                <p style={{ fontFamily:'var(--font-body)', fontSize:'9px', fontWeight:600, letterSpacing:'0.32em', textTransform:'uppercase', color:'var(--accent)', marginBottom:'10px' }}>Founder & Producer</p>
                <p style={{ fontFamily:'var(--font-body)', fontSize:'13px', lineHeight:1.7, color:'var(--white-70)' }}>
            ...
            <Reveal delay={0.2}>
              <div style={{ position:'relative' }}>
                ...
                <h3 style={{ fontFamily:'var(--font-display)', fontSize:'clamp(18px,2vw,28px)', textTransform:'uppercase', color:'var(--white)', marginBottom:'4px', lineHeight:1 }}>Ashna Chhabra</h3>
                <p style={{ fontFamily:'var(--font-body)', fontSize:'9px', fontWeight:600, letterSpacing:'0.32em', textTransform:'uppercase', color:'var(--accent)', marginBottom:'10px' }}>Co-Founder & Creative Director</p>
                <p style={{ fontFamily:'var(--font-body)', fontSize:'13px', lineHeight:1.7, color:'var(--white-70)' }}>
